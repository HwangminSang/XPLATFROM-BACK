...
login.addEventListener("click", function() {
  ...
  $.ajax({
    type: 'GET',
    url: '/login', //   contextPath 없어도 가능 -> 서버를 artifact 를  조작하면 됨...
    data: {
      method: 'LogInCheck',
...
const companyData = () => {
  $.ajax({
    type: 'GET',
    url: '/basicInfo/searchCompany', //   contextPath 없어도 가능 -> 서버를 artifact 를  조작하면 됨...
    data: {
...
const workplaceData = () => {
  $.ajax({
    type: 'GET',
    url: '/basicInfo/searchWorkplace', //   contextPath 없어도 가능 -> 서버를 artifact 를  조작하면 됨...
    data: {
      companyCode: companyCode.value,
